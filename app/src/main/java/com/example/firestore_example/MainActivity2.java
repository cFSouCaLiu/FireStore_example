...
//      //et d'un taost pour L'UX
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull @org.jetbrains.annotations.NotNull Exception e) {
                        Toast.makeText(MainActivity2.this, "Erreur lors de l'envoi",
...
//                            String note = documentSnapshot.getString(KEY_NOTE);
                            ...
                            Toast.makeText(MainActivity2.this, "Le doc n'existe pas ! ",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                })
    ...
    public void deleteNote(View view) {
        ...
        .addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(MainActivity2.this, "La note est bien supprimee ! ", Toast.LENGTH_SHORT).show();
            }
        })
        ...
        noteRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(MainActivity2.this, "Toute la note est bien supprimee ! ",
                        Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
    ...
    protected void onStart() {
        noteRef.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable @org.jetbrains.annotations.Nullable DocumentSnapshot value,
                ...
                if(error != null){
                    Toast.makeText(MainActivity2.this, "Erreur de chargment !",
                            Toast.LENGTH_SHORT).show();
